...
def writeTunnelRules(p4info_helper, ingress_sw, egress_sw, tunnel_id,
    ...
    # 观察拓扑可知，1->3,3->2,2->3从3出 || 3->1,1->2,2->1从2出
    if tunnel_id == 103 or tunnel_id == 302 or tunnel_id == 203:
        outPort = 3
    else:
        outPort = 2
    ...
    table_entry = p4info_helper.buildTableEntry(
        ...
        # 如果只让s1和s2通信，那么switch_to_switch_port确实恒为2，但这里需要补充s3，就要修改port
        action_params={
            "port": outPort
        })
    ingress_sw.WriteTableEntry(table_entry)
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        s3.SetForwardingPipelineConfig(p4info=p4info_helper.p4info,
         ...
         # 规定h1->h3的隧道id为103，即1_to_3,依次类推规定所有tunnel_id
        ...
        # 补充h3和h1、h2之间的tunnel traffic rule
