...
control MyIngress(inout headers hdr,
    ...
    action set_ecmp_select(bit<16> ecmp_base, bit<32> ecmp_count) {
        ...
        //    根据源ip、目的ip、ip协议、源TCP端口、目的TCP端口组成的5元组做一次哈希计算，其结果用于决定数据包的下一条路径
        //    meta.ecmp_select是一个out参数，将计算结果保存在此参数，若ecmp_count>=1，则结果为[ecmp_base,ecmp_base+ecmp_count-1]，若ecmp_count==0,则结果为ecmp_base
